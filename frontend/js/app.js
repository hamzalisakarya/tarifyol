const translations = {
    de: {
        pageTitle: "TarifYol – Strom, Gas, Internet & Kfz",
        skipLink: "Zum Inhalt springen",
        menuLabel: "Menü öffnen",
        mainNavigation: "Hauptnavigation",
        languageNavigation: "Sprachauswahl",
        legalNavigation: "Rechtliche Hinweise",
        navServices: "Bereiche",
        navProcess: "So funktioniert’s",
        navAbout: "Ihre Daten",
        navTransparency: "Hinweise",
        navGuide: "Ratgeber",
        navAboutPage: "Über TarifYol",
        contactShort: "Kontakt",
        heroEyebrow: "TarifYol · Deutsch & Türkçe",
        headline: "Dein Weg durch Strom, Gas & Internet.",
        supportLanguages: "Tarife einfach prüfen – persönlich, verständlich und auf Deutsch & Türkçe.",
        heroCopy: "TarifYol begleitet dich klar und persönlich bei der ersten Tarifprüfung und den nächsten Schritten.",
        ...
        servicesTitle: "Strom, Gas und Internet auf einen Blick",
        servicesIntro: "Wählen Sie Ihren Bereich. Wir prüfen die nächsten Möglichkeiten gemeinsam und verständlich.",
        electricityTitle: "Strom",
        electricityText: "Stromtarife prüfen und den nächsten Schritt in Ruhe vorbereiten.",
        electricityCta: "Stromtarif prüfen →",
        gasTitle: "Gas",
        gasText: "Gastarife prüfen und die eigenen Vertragsdaten besser einordnen.",
        internetTitle: "Internet",
        internetText: "DSL, Kabel und Glasfaser verständlich einordnen und Optionen prüfen.",
        ...
        stepOne: "Angaben senden",
        stepOneText: "Für die erste Prüfung senden Sie nur die grundlegenden Tarifangaben.",
        stepTwo: "Möglichkeiten prüfen",
        stepTwoText: "Wir prüfen die nächsten Möglichkeiten auf Grundlage Ihrer Angaben.",
        stepThree: "In Ruhe entscheiden",
        stepThreeText: "Sie erhalten eine verständliche Einordnung und entscheiden selbst, ob Sie weitermachen möchten.",
    ...
    tr: {
        ...
        navAbout: "Verileriniz",
        navTransparency: "Açıklamalar",
        navGuide: "Rehber",
        navAboutPage: "Hakkımızda",
        contactShort: "İletişim",
        heroEyebrow: "TarifYol · Deutsch & Türkçe",
        headline: "Elektrik, doğal gaz ve internette yolunuz TarifYol ile açık.",
        supportLanguages: "Tarifeleri kolayca kontrol edin – kişisel, anlaşılır destek Almanca ve Türkçe.",
        heroCopy: "TarifYol ilk tarife kontrolünde ve sonraki adımlarda size açık ve kişisel destek sunar.",
        ...
        servicesTitle: "Elektrik, doğal gaz ve internet tek bakışta",
        servicesIntro: "Alanınızı seçin. Sonraki seçenekleri birlikte ve anlaşılır şekilde inceleyelim.",
        electricityTitle: "Elektrik",
        electricityText: "Elektrik tarifelerini kontrol edin ve sonraki adımı sakin bir şekilde hazırlayın.",
        electricityCta: "Elektrik tarifeni kontrol et →",
        gasTitle: "Doğal Gaz",
        gasText: "Doğal gaz tarifelerini kontrol edin ve sözleşme bilgilerinizi daha iyi anlayın.",
        internetTitle: "İnternet",
        internetText: "DSL, kablo ve fiber seçeneklerini anlayın ve uygunlukları kontrol edin.",
        ...
        stepOne: "Bilgileri gönderin",
        stepOneText: "İlk kontrol için yalnızca temel tarife bilgilerini gönderin.",
        stepTwo: "Seçenekleri inceleyin",
        stepTwoText: "Verdiğiniz bilgilere göre sonraki seçenekleri inceleyelim.",
        stepThree: "Sakin bir şekilde karar verin",
        stepThreeText: "Anlaşılır bir değerlendirme alır ve devam edip etmeyeceğinize kendiniz karar verirsiniz.",
...
try {
    ...
    if (!savedLanguage) {
        savedLanguage = localStorage.getItem(legacyStorageKey) || "de";
        if (savedLanguage === "de" || savedLanguage === "tr") {
            localStorage.setItem(storageKey, savedLanguage);
        }
    }
} catch {
